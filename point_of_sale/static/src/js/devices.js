...
function openerp_pos_devices(instance,module){ //module is instance.point_of_sale
    ...
    module.ProxyDevice  = instance.web.Class.extend({
        init: function(options){
            options = options || {};
            url = options.url || 'http://debian-dev:40069';
    ...
    module.BarcodeReader = instance.web.Class.extend({
        ...
        init: function(attributes){
            ...
            this.lot_prefix_set      = attributes.lot_prefix_set      ||  {'24':''}; // 20150423 - EAN13 LOT SUPPORT
        ...
        parse_ean: function(ean){
            ...
            } else if( match_prefix(this.lot_prefix_set,'lot')){ // 20150423 - EAN13 LOT SUPPORT
                parse_result.id = ean.substring(0,12);
                parse_result.type = 'lot';
