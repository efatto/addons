function openerp_pos_models(instance, module){ //module is instance.point_of_sale
    ...
    module.PosModel = Backbone.Model.extend({
        ...
        load_server_data: function(){
            ...
            var loaded = self.fetch('res.users',['name','company_id'],[['id','=',this.session.uid]])
                .then(function(users){
                    ...
                    // 20150423 - EAN13 LOT SUPPORT
                    return self.fetch('stock.production.lot', ['product_id', 'ref'], []);
                }).then(function(lots){ // 20150423 - EAN13 LOT SUPPORT
                    self.db.add_lots(lots);
                });
        ...
        // 20150423 - EAN13 LOT SUPPORT
        scan_lot: function(parsed_ean){
            var self = this;
            var product = this.db.get_product_by_lot_ean13(parsed_ean.base_ean);
            var selectedOrder = this.get('selectedOrder');
            ...
            selectedOrder.addProduct(new module.Product(product.data), {'lot_id': product.lot_id});
    ...
    module.Orderline = Backbone.Model.extend({
        initialize: function(attr,options){
            ...
            this.prodlot_id = options.prodlot_id; // 20150423 - EAN13 LOT SUPPORT
        ...
        export_as_JSON: function() {
            return {
                ...
                prodlot_id: this.prodlot_id ? this.prodlot_id : false,
            };
        },
    ...
    module.Order = Backbone.Model.extend({
        ...
        addProduct: function(product, options){
            options = options || {};
            var lot_id = options['lot_id']; // 20150423 - EAN13 LOT SUPPORT
            var attr = product.toJSON();
            attr.pos = this.pos;
            attr.order = this;
            // 20150423 - EAN13 LOT SUPPORT
            var line = new module.Orderline({}, {'pos': this.pos, 'order': this, 'product': product, 'prodlot_id': lot_id});
